...
QShop has no mandatory gameplay integration dependencies. KubeJS and FTB Quests are optional and only needed for their respective features. Stage requirements use KubeJS PlayerStages or AStages on this NeoForge 1.21.1 branch. The NeoForge 26.1.2 release uses KubeJS PlayerStages because AStages does not currently provide a 26.1.2 build.
...
- AStages server stages and player stages are also supported on NeoForge 1.21.1; either matching stage can unlock a requirement.
