...
Install KubeJS on the server to enable the global `QShop` binding. The public 1.0.4 API is Builder-first. JSON CRUD methods and direct `JsonIO` writes are not part of the public global API.
